...
public class Kuulanici {
     ...
     * Constructor
     ***************************************************************************/   
    public Kuulanici(Database rDatabase) {
    ...
    public void showMainMenu(int userType)
    {
        ...
        if( userType != Islemler.USER_ANONYMOUS)
        {
        ...
        if( userType == Islemler.USER_MANAGER)
        {
    ...
    public void editMenuItemView(Menu rMenuItem)
    {
        clearScreen();
    ...
    {
        Iterator<Siparis_duzen> it = crDatabase.getOrderList().iterator();
        String          state;
        String          output;
    ...
    {
        Siparis_duzen rOrder = crDatabase.findOrderByID(orderID);
    ...
    {
        Iterator<Menu> it = crDatabase.getMenuList().iterator();
