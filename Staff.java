...
{
    private int ID; // Calisanlarin bilgileri icin degiskenler olusturuluyor.
    private String lastName;
    private String firstName;
    private String password;
    private byte    state;
    
    private Siparis_duzen[] orderList;
    ...
    public double culculateWorkTime()
    {
        ...
        long diffTimeMin = (finishWorkTime.getTime() - startWorkTime.getTime()) / 60000;
